...
urlpatterns = [
    ...
    path('templates/<int:pk>/update/', views.default_account_template_update, name='default_account_template_update'),
    path('templates/<int:pk>/delete/', views.default_account_template_delete, name='default_account_template_delete'),
