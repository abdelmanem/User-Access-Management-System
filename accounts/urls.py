...
urlpatterns = [
    ...
    path('ldap/sync-user-fields/', ldap_views.ldap_sync_user_fields, name='ldap_sync_user_fields'),
    path('ldap/sync-computer-fields/', ldap_views.ldap_sync_computer_fields, name='ldap_sync_computer_fields'),
]